...
class FieldsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'form_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'weight' => 1,
            'required' => 1,
            'created' => '2017-12-09 04:01:06',
            'modified' => '2017-12-09 04:01:06',
            'deleted' => '2017-12-09 04:01:06'
        ],
    ];
}
